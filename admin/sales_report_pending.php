...
if(isset($_GET['submit'])){
    ...
    if(!empty($from) && !empty($to)){
        ...
        echo "<b>Report of Pending Sales Made from {$from} to {$to}</b><br><br>";
        echo "<b>Number of Pending Sales: {$total_invoice} Results</b><br><br>";
...
if(isset($total, $from, $to)){
    ...
    for($i = 1; $i <= $total; $i++){
        ...
        echo "<li>
            <a href='sales_report_pending?page={$i}&from={$from}&to={$to}&submit=1'>
